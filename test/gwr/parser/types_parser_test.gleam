...
pub fn parse_function_type___empty_vectors___test()
{
    ...
    |> should.be_ok
    |> pair.second
    |> should.equal(types.FunctionType(parameters: [], results: []))
}
...
pub fn parse_global_type___constant___test()
{
    ...
    |> should.be_ok
    |> pair.second
    |> should.equal(types.GlobalType(value_type: types.Number(types.Integer32), mutability: types.Constant))
}
...
pub fn parse_global_type___variable___test()
{
    ...
    |> should.be_ok
    |> pair.second
    |> should.equal(types.GlobalType(value_type: types.Number(types.Integer64), mutability: types.Variable))
}
...
pub fn parse_limits___no_max___test()
{
    ...
    |> should.be_ok
    |> pair.second
    |> should.equal(types.Limits(min: 3, max: None))
}
...
pub fn parse_limits___with_max___test()
{
    ...
    |> should.be_ok
    |> pair.second
    |> should.equal(types.Limits(min: 32, max: Some(256)))
}
...
pub fn parse_value_type___integer_32___test()
{
    ...
    |> should.be_ok
    |> pair.second
    |> should.equal(types.Number(types.Integer32))
}
...
pub fn parse_value_type___integer_64___test()
{
    ...
    |> should.be_ok
    |> pair.second
    |> should.equal(types.Number(types.Integer64))
}
...
pub fn parse_value_type___float_32___test()
{
    ...
    |> should.be_ok
    |> pair.second
    |> should.equal(types.Number(types.Float32))
}
...
pub fn parse_value_type___float_64___test()
{
    ...
    |> should.be_ok
    |> pair.second
    |> should.equal(types.Number(types.Float64))
}
...
pub fn parse_value_type___vector_128___test()
{
    ...
    |> should.be_ok
    |> pair.second
    |> should.equal(types.Vector(types.Vector128))
}
...
pub fn parse_value_type___function_reference___test()
{
    ...
    |> should.be_ok
    |> pair.second
    |> should.equal(types.Reference(types.FunctionReference))
}
...
pub fn parse_value_type___extern_reference___test()
{
    ...
    |> should.be_ok
    |> pair.second
    |> should.equal(types.Reference(types.ExternReference))
}
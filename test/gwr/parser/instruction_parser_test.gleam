...
pub fn parse_block_type___empty_block___test()
{
    ...
    |> should.be_ok
    |> pair.second
    |> should.equal(instruction.ValueTypeBlock(type_: option.None))
}
...
pub fn parse_block_type___value_type_block___test()
{
    ...
    |> should.be_ok
    |> pair.second
    |> should.equal(instruction.ValueTypeBlock(type_: option.Some(types.Number(types.Integer32))))
}
...
pub fn parse_block_type___type_index_block___test()
{
    ...
    |> should.be_ok
    |> pair.second
    |> should.equal(instruction.TypeIndexBlock(index: 65536))
}
...
pub fn parse_instruction___i32_const___test()
{
    ...
    |> should.be_ok
    |> pair.second
    |> should.equal(instruction.I32Const(value: 1048576))
}
...
pub fn parse_instruction___local_get___test()
{
    ...
    |> should.be_ok
    |> pair.second
    |> should.equal(instruction.LocalGet(index: 255))
}
...
pub fn parse_instruction___local_tee___test()
{
    ...
    |> should.be_ok
    |> pair.second
    |> should.equal(instruction.LocalGet(index: 65536))
}
...
pub fn parse_instruction___br___test()
{
    ...
    |> should.be_ok
    |> pair.second
    |> should.equal(instruction.Br(index: 255))
}
...
pub fn parse_instruction___br_if___test()
{
    ...
    |> should.be_ok
    |> pair.second
    |> should.equal(instruction.BrIf(index: 65536))
}
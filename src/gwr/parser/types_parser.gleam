...
pub fn parse_value_type(from reader: binary_reader.BinaryReader) -> Result(#(binary_reader.BinaryReader, types.ValueType), String)
{
...
pub fn parse_limits(from reader: binary_reader.BinaryReader) -> Result(#(binary_reader.BinaryReader, types.Limits), String)
{
...
pub fn parse_function_type(from reader: binary_reader.BinaryReader) -> Result(#(binary_reader.BinaryReader, types.FunctionType), String)
{
...
pub fn parse_global_type(from reader: binary_reader.BinaryReader) -> Result(#(binary_reader.BinaryReader, types.GlobalType), String)
{

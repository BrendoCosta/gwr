...
pub type GlobalIndex =
  Int

pub type ElementIndex =
  Int
...
pub type Instruction {
  ...
  If(
    ...
    else_: option.Option(Instruction),
  )
...
pub type FunctionInstance {
  ...
  HostFunctionInstance(
    type_: FunctionType,
    code: fn(List(dynamic.Dynamic)) -> List(dynamic.Dynamic),
  )
}
...
pub type Binary {
  Binary(version: Int, length: Int, module: Module)
}
